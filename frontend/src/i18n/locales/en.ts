...
export const en = {
  ...
  wallet: {
    ...
    tooltip: {
      ...
      retryingStatus: "Retrying wallet connection...",
    },
    heartbeat: {
  ...
  networkWarning: {
    ...
    fixNow: "Show me how to fix this",
    guide: {
      title: "Switch your wallet's network",
      description: "Your wallet is on {{wallet}}, but this app needs {{expected}}. Follow these steps in Freighter, then check again.",
      step1: "Open the Freighter extension.",
      step2: "Go to Settings → Network.",
      step3: "Select {{expected}} from the network list.",
      checkAgain: "I've switched — check again",
      checking: "Checking…",
      stillMismatched: "Still on {{wallet}}. Double-check the steps above, then try again.",
      resolved: "You're on {{expected}} now — you're all set!",
      close: "Close",
    },
  },
  accountStatement: {
  ...
  vaultDashboard: {
    ...
    feeUtilization: {
      title: "Fees & Utilization",
      subtitle: "The protocol fee charged on yield, and the share of vault capital deployed to the strategy.",
      currentFee: "Current protocol fee",
      utilization: "Strategy utilization",
      baseFee: "Base fee",
      dynamicOn: "Dynamic",
      dynamicOff: "Flat rate",
      loading: "Loading fee and utilization data…",
      unavailable: "Fee and utilization data is not being reported by this vault.",
      meterText: "Strategy utilization is {{percent}}",
      kinkLabel: "Optimal utilization",
      curveSummary: "Fees scale from {{base}} at no utilization to {{optimal}} at the {{kink}} optimal point, then up to {{max}} when the vault is fully deployed.",
    },
    riskSummary: {
    ...
    toast: {
      ...
      transactionErrors: {
        walletRejected: "Your wallet cancelled the request. Approve it in Freighter to continue, or choose Start Over.",
        walletPermission: "Freighter did not authorize this request. Unlock the wallet and approve access, then try again.",
        network: "The Stellar network or wallet did not respond. Check your connection and try again.",
        insufficientFunds: "The wallet or vault does not have enough available funds. Reduce the amount or try again later.",
        contractState: "The vault cannot complete this request right now. Review the amount and vault status, then try again.",
        validation: "The request could not be validated. Review the amount and try again.",
        unknown: "The transaction could not be completed. Try again or start over.",
      },
    },
    ...
    tokens: "Tokens: USDC",
    position: {
      ariaLabel: "Your vault position",
      title: "Your vault position",
      subtitle: "Your shares represent your portion of the vault.",
      value: "Current value",
      shares: "Vault shares",
      sharePrice: "Share price",
      accrual: "Value changes as yield accrues",
      noPosition: "Deposit to receive vault shares",
      loading: "Loading...",
      unavailable: "Unavailable",
      helpLabel: "Learn how vault shares work",
      help: "Vault value = your yvUSDC shares x the current share price. Your share quantity stays the same while its USDC value can grow as yield accrues.",
    },
    ...
    depositHelperText: "Min: {{min}} USDC · Max: {{max}} USDC · Up to {{decimals}} decimal places",
  ...
  strategyDetail: {
    ...
    notFoundDesc: "The strategy you are looking for does not exist or may have been renamed.",
    browseCompare: "Browse all strategies",
    summaryHeading: "Strategy summary",
    netApyLabel: "Net APY",
    issuerLabel: "Issuer",
    minimumLabel: "Minimum deposit",
    depositCta: "Deposit via dashboard",
    viewCompareCta: "Compare strategies",
    metricsHeading: "Key terms",
    liquidityLabel: "Liquidity",
    lockupLabel: "Lockup",
    settlementLabel: "Settlement",
    riskHeading: "Risk profile",
    riskFactorsLabel: "What we monitor at this tier",
    yieldHeading: "Yield model",
    yieldModelIntro: "This strategy targets a net annualised yield of {apy}. Yield accrues from the underlying instruments and is distributed to depositors through the vault share price.",
    yieldCompounding: "Yield compounds daily and is reflected in the yvUSDC exchange rate rather than paid out separately.",
    yieldNetOfFees: "Quoted figures are net of protocol and management fees, so what you see is what accrues to your position.",
    methodologyHeading: "Methodology & sources",
    methodologySource: "Strategy terms come from issuer documentation and are reviewed against on-chain vault configuration each rebalance epoch.",
    methodologyNetFigures: "APY is annualised from realised vault share-price performance and quoted net of fees; past windows are shown for context only.",
    methodologySimulation: "Where live history is unavailable, figures are clearly labelled simulated context derived from the same share-price index (100 = baseline).",
    methodologyDisclaimer: "Educational information only — not investment advice. Verify current terms with the issuer before allocating capital.",
    historyHeading: "Historical performance",
    historySubtitle: "yvUSDC share price index over the recorded window (100 = baseline)",
    historyEmptyTitle: "No history recorded yet",
    historyEmptyDesc: "Share-price points will appear here once the vault records its first observations.",
    relatedHeading: "Other strategies",
